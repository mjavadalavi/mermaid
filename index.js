...
app.post('/render', (req, res) => {
    ...
    try {
        ...
        // Try a different approach for passing puppeteer arguments
        // First, create a puppeteer config file
        const puppeteerConfigFile = path.join(tempDir, `puppeteer_${timestamp}.json`);
